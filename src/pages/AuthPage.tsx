                    ...
                    <div className="p-8">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-6 flex flex-col items-center gap-3">
                                ...
                                <button
                                    type="button"
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-800 hover:bg-gray-750 border border-gray-700 rounded-lg text-white transition-all transform hover:translate-y-[-2px]"
                                >
