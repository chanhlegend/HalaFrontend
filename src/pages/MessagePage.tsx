...
const MessagePage: React.FC = () => {
    ...
    return (
        <div className="flex h-[calc(100vh-80px)] md:h-screen bg-[#1a1a1a] overflow-hidden">
            {/* Conversation List */}
            <div className={`w-full md:w-80 md:min-w-[320px] border-r border-gray-800 flex flex-col ${selectedConversation ? 'hidden md:flex' : 'flex'}`}>
                {/* Header */}
                <div className="p-3 sm:p-4 border-b border-gray-800 flex-shrink-0">
                    <h2 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Tin nhắn</h2>
                        ...
                        filteredConversations.map(conv => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`flex items-center gap-2 sm:gap-3 p-3 sm:p-4 cursor-pointer hover:bg-gray-800 transition-colors ${selectedConversation?._id === conv._id ? 'bg-gray-800' : ''} ${hasUnread ? 'bg-purple-500/5' : ''}`}
                                >
                                    {/* Avatar with online indicator potential */}
                                    <div className="relative flex-shrink-0">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold overflow-hidden text-sm sm:text-base">
                ...
                {selectedConversation ? (
                    <>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 border-b border-gray-800 flex-shrink-0">
                            ...
                            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold overflow-hidden flex-shrink-0">
                            ...
                            <div className="min-w-0 flex-1">
                                <h3 className="font-medium text-white text-sm sm:text-base truncate">{selectedConversation.participant?.name}</h3>
                                <p className="text-xs text-gray-400 truncate hidden sm:block">{selectedConversation.participant?.email}</p>
                            </div>
                            {/* Video Call Button */}
                            <button
                                onClick={async () => {
                        ...
                        {/* Message Input */}
                        <form onSubmit={handleSendMessage} className="p-3 sm:p-4 border-t border-gray-800 flex-shrink-0">
                            <div className="flex items-center gap-2 sm:gap-3">
                                <input
                                    ...
                                    className="flex-1 bg-gray-800 text-white px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
                                />
                                <button
                                    type="submit"
                                    disabled={!newMessage.trim() || sendingMessage}
                                    className="bg-purple-600 text-white p-2.5 sm:p-3 rounded-xl hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                                >
                                    <Send size={20} />
                                </button>
                            </div>
